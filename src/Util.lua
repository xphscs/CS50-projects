...
function GenerateQuads(atlas, tilewidth, tileheight)
    ...
    spritesheet[24] = love.graphics.newQuad (160, 48, tilewidth, tileheight, atlas:getDimensions())
    return spritesheet
end
...
function GenerateQuadsPowerUp (atlas)
    ...
    quad = love.graphics.newQuad (128, 192, 16, 16, atlas:getDimensions())
...
function GenerateQuadsKey (atlas)
    local quad 
    quad = love.graphics.newQuad (144, 192, 16, 16, atlas:getDimensions())
    return quad
end
