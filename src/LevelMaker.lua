...
function LevelMaker.createMap(level)
    ...
    local lockedbrickX = math.random (7, numCols)
    local lockedbrickY = math.random (1, numRows)
    ...
    for y = 1, numRows do
        ...
        for x = 1, numCols do
            ...
            if LMKeyFlag == true and x == lockedbrickX and y == lockedbrickY then
             b = Brick ( (x-1)               
                * 32                    
                + 8                     
                + (13 - numCols) * 16,  
